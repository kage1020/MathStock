...
<Tabs>
  ...
  <TabItem label="解答">
    ...
    <Image className="w-[400px]" src={["/past-exams/titech/1984/f1_light.drawio.svg","/past-exams/titech/1984/f1_dark.drawio.svg"]} caption="(i)" />
    <Image className="w-[400px]" src={["/past-exams/titech/1984/f2_light.drawio.svg","/past-exams/titech/1984/f2_dark.drawio.svg"]} caption="(ii)" />
